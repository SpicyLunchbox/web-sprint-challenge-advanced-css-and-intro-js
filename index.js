...
function get20s(array){
  ...
  for (let i = 0; i < array.length; i++){
    if (array[i]["years"][1].includes('9') && array[i]["years"][8].includes('9')){
      newArray.unshift(array[i]["name"]);
    }
  }
  newArray.reverse(); //for an autograder pass, the new array has to be reversed, even though the Task directions don't mention this
  return newArray;
}
...
function lotsOfArt(array){
  ...
  for (let i = 0; i < array.length; i++){
    if (array[i]["paintings"] > 100) {
      newArray2.unshift(array[i]["name"]);
    }
  }
  newArray2.reverse(); //for an autograder pass, the new array has to be reversed, even though the Task directions don't mention this
  return newArray2;
}
